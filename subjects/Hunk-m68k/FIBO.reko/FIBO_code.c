		...
		if (d0_n != null)
		{
			...
			if (d0_n == null)
			{
				...
				if (d0_n == 0x00)
				{
					...
					word32 a1_n;
					word32 d1_n;
					fn0000127C(20, out d1_n, out a1_n, out a5_n);
					return;
				}
				g_t3EA8 = d0_n;
				g_t3EAC = d0_n;
...
l00001202:
						...
						word32 d1_n;
						word32 a5_n;
						fn0000127C(0, out d1_n, out a1_n, out a5_n);
						return;
					}
					goto l000011F8;
				}
...
word32 fn000012D0(Eq_n dwArg04, ptr32 & d1Out, ptr32 & a1Out, ptr32 & a5Out)
{
	if (0x3FDC != 0x00)
	{
		...
		for (d2_n = d2_n - 0x01; d2_n != 0x00; --d2_n)
		{
			...
			(&(&(&(&(&(&(&(&(&(&(&(&(&(&(&(&(&(&(&((Eq_n[]) 0x3FDC)[d0_n / 4].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0].a0000)[0]();
		}
	}
	ptr32 a1_n;
	ptr32 a5_n;
...
void fn00001354(int32 dwArg04, struct Eq_n * dwArg08)
{
	...
	word32 d1_n;
	word32 a1_n;
	fn0000131C(fn00001390(), out d1_n, out a1_n, out a5_n);
}
...
word32 fn00001390()
{
	byte ** a1_n;
	Eq_n d1_n;
	fn00002BDC(fn00003E04(&g_b1438, out d1_n, out a1_n), d1_n, a1_n, &g_t1458);
	...
	while (d2_n - dwLoc0C <= 0x00)
	{
		byte ** a1_n;
		Eq_n d1_n;
		fn00002BDC(fn00003E04(&g_b1410, out d1_n, out a1_n), d1_n, a1_n, &g_t1420);
...
l000019D0:
					...
					do
					{
						...
						a7_n->tFFFFFFEC = d7_n;
						a7_n->tFFFFFFE8 = d6_n;
						int32 d1_n = fn0000279C(a7_n->tFFFFFFE8, a7_n->tFFFFFFEC, a7_n->tFFFFFFF0, a7_n->tFFFFFFF4);
						...
						*a3_n = (byte) *((word32) v148_n.u1 + d1_n);
						...
						a7_n->tFFFFFFE8 = d6_n;
						Eq_n d1_n;
						Eq_n d0_n = fn00002454(a7_n->tFFFFFFE8, a7_n->tFFFFFFEC, a7_n->tFFFFFFF0, a7_n->tFFFFFFF4, out d1_n, out a0_n);
						a1_n = a7_n->tFFFFFFF8;
						d6_n = d0_n;
						d7_n = d1_n;
						a7_n = (struct Eq_n *) ((char *) &a7_n->t0000 + 4);
				...
				if ((a7_n[18] & 2) != 0x00)
				{
					...
					if (d7_n != null)
					{
						do
						{
							...
							if (fn00001E34(a7_n->tFFFFFFFC, a7_n->ptr0000, out a0_n, out a5_n) == ~0x00)
								return;
							d2_n = (word32) d2_n + 1;
							d6_n = (word32) d6_n + 1;
				...
				if ((a7_n[18] & 4) == 0x00)
				{
					...
					if (a7_n[0x0C] != 0x00)
					{
						...
						do
						{
							...
							if (fn00001E34(a7_n->dwFFFFFFF8, a7_n->dwFFFFFFFC, out a0_n, out a5_n) == ~0x00)
								return;
							d2_n = (word32) d2_n + 1;
							d6_n = (word32) d6_n + 1;
				...
				if (d0 != 0x00)
				{
					...
					if (a7_n[0x0C] != 0x00)
					{
						...
						do
						{
							...
							word32 a0_n;
							d0 = fn00001E34(a7_n->tFFFFFFFC, a7_n->ptr0000, out a0_n, out a5_n);
							if (d0 == ~0x00)
								return;
							d2_n = (word32) d2_n + 1;
							d6_n = (word32) d6_n + 1;
...
Eq_n fn00001E34(Eq_n dwArg04, struct Eq_n * dwArg08, ui32 & a0Out, ptr32 & a5Out)
{
	...
	{
		word32 a1_n;
		d1_n = fn00001E90(dwArg04, dwArg08, out a0_n, out a1_n, out a5);
	}
	a0Out = a0_n;
	a5Out = a5;
	return d1_n;
...
int32 fn00001E90(Eq_n dwArg04, struct Eq_n * dwArg08, ui32 & a0Out, ptr32 & a1Out, ptr32 & a5Out)
{
	...
	if (dwArg08->ptr0008 == null)
	{
		...
		if ((dwArg08->dw0018 & 0x80) != 0x00)
			...
			d4_n = 1;
		word32 d1_n;
		int32 d0_n = fn00002050(d4_n + dwArg08->dw001C, out d1_n, out a0, out a1_n);
		if (d0_n == 0x00)
		{
			d0_n = -1;
			goto l00001F9E;
	...
	else
	{
		...
		if (d0_n != 0x00)
		{
			...
			if (dwArg04 == 0x0A)
			{
				...
				dwArg08->ptr0004 = (ui32 *) ((char *) a0_n + 1);
				*a0_n = (ui32) (byte) dwArg04;
				d0_n = fn00001FA4(dwArg08, out a0, out a1_n, out a5_n);
				goto l00001F9E;
			}
		}
...
Eq_n fn00002050(int32 dwArg04, ptr32 & d1Out, ptr32 & a0Out, int32 & a1Out)
{
	...
	else
	{
		if (g_ptr3ECC == null)
		{
			struct Eq_n * a0_n = g_ptr3EC8;
			null = null;
			g_ptr3ECC = fn00002344(dwLoc10, a0_n, a0_n, out d1, out a0, out a1);
		}
		if (g_ptr3ECC == null)
			d0_n.u0 = 0;
		else
		{
			int32 * d0_n = fn00002220(g_ptr3ECC, dwArg04 + 4, out d1, out a0);
			a1 = d0_n;
			if (d0_n == null)
				d0_n.u0 = 0;
			else
...
{
	if (dwArg04 != null && g_ptr3ECC != null)
		fn00002184(g_ptr3ECC, dwArg04 - 4, dwArg04->dwFFFFFFFC + 4);
}
...
word32 fn00002424(ptr32 & a1Out, ptr32 & a5Out)
{
	...
	word32 d1_n = 0x1000;
	if (0x00 != 0x00)
		fn0000131C(0x14, out d1_n, out a1, out a5);
	a1Out = a1;
	a5Out = a5;
	return d1_n;
}
...
Eq_n fn00002454(Eq_n dwArg04, Eq_n dwArg08, Eq_n dwArg0C, Eq_n dwArg10, union Eq_n & d1Out, union Eq_n & a0Out)
{
	...
	if (dwArg0C != 0x00)
	{
		if (dwArg04 - dwArg0C >= 0x00)
		{
			...
			int32 d4_n = SEQ(SLICE(d4_n, word24, 8), ((&g_t3ED0)[(int32) ((word16) d6_n & 0xFF)].a0000 + (byte) d4_n).a0000.a0000.a0000.a0000.a0000.a0000.a0000.a0000.a0000.a0000.a0000.a0000.a0000.a0000.a0000.a0000.a0000.a0000.a0000);
			int32 d5_n = 32 - d4_n;
			if (d5_n != 0x00)
			{
				word32 d1_n;
	...
	else
	{
		if (dwArg04 - dwArg10 >= 0x00)
		{
			...
			Eq_n d1_n;
			Eq_n d2_n;
			Eq_n d0_n = fn00002558(0, dwArg04, d3_n, out d1_n, out d2_n);
			word32 d2_n;
			word32 d1_n;
...
Eq_n fn0000279C(Eq_n dwArg04, Eq_n dwArg08, Eq_n dwArg0C, Eq_n dwArg10)
{
	...
	if (dwArg0C == 0x00)
	{
		...
		else
		{
			...
			Eq_n d1_n;
			Eq_n d2_n;
			fn00002558(0, dwArg04, d3_n, out d1_n, out d2_n);
			word32 d2_n;
	...
	if (dwArg08->b0000 != 0x00)
	{
		do
		{
			...
			if (a4_n->b0000 == 0x25)
			{
				...
				a7_n->b0049 = 0x00;
				byte * a3_n = a4_n + 1;
				uint32 d0_n = (uint32) (uint8) (&g_t28B1)[(uint32) (uint8) *a3_n];
				Eq_n d6_n = -1;
				d0 = d0_n & 0x04;
				if ((d0_n & 0x04) != 0x00)
				{
						...
						*a0_n = v83_n;
						...
						else
						{
							...
							*a7_n = (union Eq_n *) a2_n;
							word32 d1_n;
							word32 a5_n;
							d0_n = fn00003CCC(*a7_n, out d1_n, out a1, out a5_n);
							d1 = d0_n;
						}
						uint32 d0_n = (uint32) (uint8) (&g_t28B1)[SEQ(SLICE(d0_n, word24, 8), (byte) d1) & 0xFF];
						d5_n = d1;
						d4_n = (word32) d4_n + 1;
						d0 = d0_n & 0x08;
									...
									if ((byte) d7 == 0x69)
									{
										if (d5_n == 0x30 && d6_n - d3_n >= 0x00)
										{
											...
											*a0_n = v194_n;
											...
											d0 = d0_n & 0xFF;
											if (!__btst((&g_t28B1)[(int32) (int16) (d0_n & 0xFF)], 0x00))
											...
											if (d0 == 0x78 && d6_n - d3_n >= 0x00)
											{
												...
												*a0_n = v210_n;
												...
												uint32 d0_n = (uint32) (uint8) (&g_t28B1)[SEQ(SLICE(d0_n, word24, 8), (byte) d5_n) & 0xFF];
												d0 = d0_n & 0x44;
												...
												if (a7_n->dw004A != ~0x00)
												{
													...
													d0 = fn00002BF8(a7_n->bFFFFFFFF, a7_n->t0000);
												}
											}
											else
												d7.u0 = 111;
										...
										{
											uint32 d0_n = (uint32) (uint8) (&g_t28B1)[SEQ(SLICE(d0, word24, 8), (byte) d5_n) & 0xFF];
											d0 = d0_n & 0x04;
											if ((d0_n & 0x04) == 0x00)
											{
												uint32 d0_n = (uint32) (uint8) (&g_t28B1)[SEQ(SLICE(d0_n & 0x04, word24, 8), (byte) d5_n) & 0xFF];
												d0 = d0_n & 0x44;
										...
										*a0_n = v265_n;
										...
										if (d0 == 0x78 && d6_n - d3_n >= 0x00)
										{
											...
											*a0_n = v280_n;
											...
											a7_n->dw004A = (word32) a7_n[0x0D];
											uint32 d0_n = (uint32) (uint8) (&g_t28B1)[SEQ(SLICE(d0_n, word24, 8), a7_n->b0037) & 0xFF];
											d3_n = (word32) d3_n + 1;
											d4_n = d4_n + 0x01;
											d0 = d0_n & 0x44;
											if ((d0_n & 0x44) != 0x00 && d6_n - ((word32) d3_n + 1) >= 0x00)
...
l00003692:
									...
									if ((d0_n & 0x44) != 0x00)
									{
										if (a7_n->dw0072 == 0x0A)
										{
											uint32 d0_n = (uint32) (uint8) (&g_t28B1)[SEQ(SLICE(d0_n & 0x44, word24, 8), (byte) d5_n) & 0xFF];
											a7_n[33] = (struct Eq_n) d2_n;
											a7_n[0x0D] = (struct Eq_n) d4_n;
											a7_n->dw004A = (word32) (byte) d7;
											d0 = d0_n & 0x04;
...
l0000374E:
											...
											if (d6_n - d3_n >= 0x00)
											{
												...
												do
												{
													...
													word32 d1_n;
													a7_n->dw0044 = fn00003C4C(d4_n, a7_n->tFFFFFFE8, a7_n->tFFFFFFEC, a7_n->tFFFFFFF0, a7_n->tFFFFFFF4, out d1_n);
													a7_n->dw0048 = d1_n;
													if (((uint32) (uint8) (&g_t28B1)[SEQ(a7_n->n0001, (byte) d5_n) & 0xFF] & 0x04) != 0x00)
														d4_n = d5_n - 0x30;
													else
														d4_n.u0 = 0;
													Eq_n d6_n;
													...
													if (((uint32) (uint8) (&g_t28B1)[SEQ(SLICE(d0_n, word24, 8), (byte) d5_n) & 0xFF] & 0x01) != 0x00)
														d6_n = d5_n - 55;
													else
														d6_n.u0 = 0;
													Eq_n d2_n;
													...
													if (((uint32) (uint8) (&g_t28B1)[SEQ(SLICE(d0_n, word24, 8), (byte) d5_n) & 0xFF] & 0x02) != 0x00)
														d2_n = d5_n - 0x57;
													else
														d2_n.u0 = 0;
													Eq_n d0_n;
													...
													*a0_n = v341_n;
													...
													else
													{
														...
														word32 d1_n;
														word32 a5_n;
														d0_n = fn00003CCC(a7_n->dwFFFFFFFC, out d1_n, out a1, out a5_n);
														d1 = d0_n;
													}
													...
													if (d7 == 0x0A)
													{
														uint32 d0_n = (uint32) (uint8) (&g_t28B1)[SEQ(SLICE(d0_n & 0x44, word24, 8), (byte) d1) & 0xFF];
														d0 = d0_n & 0x04;
														if ((d0_n & 0x04) == 0x00)
															break;
													}
...
l0000392E:
										...
										if ((d0_n & 0x08) == 0x00 && d6_n - d3_n >= 0x00)
										{
											...
											do
											{
												...
												*a0_n = v159_n;
												...
												if (d1 == ~0x00)
													break;
												uint32 d0_n = (uint32) (uint8) (&g_t28B1)[SEQ(SLICE(d0, word24, 8), (byte) d1) & 0xFF];
												d0 = d0_n & 0x08;
						...
						else
						{
							...
							*a0_n |= 0x01;
							...
							else
							{
								...
								word32 a5_n;
								word32 a1_n;
								d0 = fn00003CCC(a7_n->t0000, out d1, out a1_n, out a5_n);
								a7_n->t0038 = d0;
					...
					else
					{
						...
						*a0_n = v431_n;
						...
						if (a7_n[11] != ~0x00)
						{
							...
							a7_n->tFFFFFFF4 = d5_n;
							d1 = (uint32) (uint8) (a7_n->ptr0000 + fn000026E4(d2_n, a7_n->tFFFFFFF4, a7_n->tFFFFFFF8));
							a1 = a7_n->ptrFFFFFFFC;
							d0 = 1 << (d5_n & 7) & d1;
			...
			{
				uint32 d0_n = (uint32) (uint8) (&g_t28B1)[SEQ(SLICE(d0, word24, 8), a4_n->b0000) & 0xFF];
				d0 = d0_n & 0x08;
				if ((d0_n & 0x08) != 0x00)
				{
					do
				...
				else
				{
					...
					*a0_n = v112_n;
					...
					else
					{
						...
						a7_n->t0000 = a2_n;
						word32 a5_n;
						a7_n->t0030 = fn00003CCC(a7_n->t0000, out d1, out a1, out a5_n);
					}
...
int32 fn00003CCC(Eq_n dwArg04, union Eq_n & d1Out, word32 & a1Out, byte & a5Out)
{
	...
	byte * a5_n;
	word32 * a1_n;
	Eq_n d1_n = fn00002424(out a1_n, out a5_n);
	if (dwArg04 == 0x00)
	{
		d0_n = -1;
		goto l00003DC2;
	...
	*((word32) dwArg04 + 24) |= 1;
	...
	if (*((word32) dwArg04 + 8) == 0x00)
	{
		...
		if ((*((word32) dwArg04 + 24) & 0x80) != 0x00)
			...
			d4_n = 1;
		word32 a0_n;
		int32 d0_n = fn00002050((word32) *((word32) dwArg04 + 28) + d4_n, out d1_n, out a0_n, out a1_n);
		d0_n = d0_n;
		if (d0_n == 0x00)
		{
			d0_n = -1;
...
struct Eq_n * fn00003DC8(ptr32 & a1Out, ptr32 & a5Out)
{
	...
	while (a2_n != null)
	{
		...
		{
			word32 a0_n;
			fn00001FA4(a2_n, out a0_n, out a1, out a5);
		}
		a2_n = a2_n->ptr000C;
		d0_n = a2_n;
	}
	...
	if (*dwArg04 != 0x00)
	{
		do
		{
			...
			else
			{
				word32 a5_n;
				word32 a0_n;
				d1 = fn00001E90((int32) (int16) *a2_n, *(struct Eq_n **) 0x3FF4, out a0_n, out a1, out a5_n);
			}
			if (d1 == -1)
			{
				d0_n = -1;
