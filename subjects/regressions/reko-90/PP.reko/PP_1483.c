...
Eq_n fn1483-0C11(byte * ds_si, word16 * es_di, Eq_n al, word16 cx, Eq_n bx, Eq_n bp)
{
	...
	if (al - 0x8C - (al < ss->*si) != 0x00 && cx != 0x01)
	{
		...
		else
		{
			...
			word16 di_n;
			struct Eq_n * es_n;
			return (word16) (uint32) (uint16) fn1483-0C91(bx, bp, ax, cx_n, (word32) si_n + 1, (word16) di_n + 1, stackArg0, out di_n, out es_n);
		}
	}
	else
		*es_di = 0x1955;
...
void fn1483-0D3F(Eq_n ds_di, Eq_n ss_bp, Eq_n ax, Eq_n cx, ui16 dx, byte bl, byte bh, Eq_n si, struct Eq_n * es, struct Eq_n * fs, byte FPUF, struct Eq_n Eq_n::* wArg02, word16 wArg06, word16 wArg0C, struct Eq_n * psegArg01A4, ui8 bArg02C1, uint8 bArg0FA0)
{
	...
	*ds_di <<= 0x68;
	word16 v22_n = -(ss->*v19_n).wFFFFFFFA;
	(ss->*v19_n).wFFFFFFFA = v22_n;
	...
	Mem141[ss:v19_n + 0xF512 + di:byte] = Mem134[ss:v19_n + 0xF512 + di:byte] + dh_n + (bx_n <u 0x00);
	...
	word16 ax_n = SEQ(ah_n, al_n);
	word16 dx_n = SEQ(dh_n - SLICE(bx_n, byte, 8) - (al_n < 0x2A), (byte) dx_n);
	if (!(sp_n - 18) || cx_n == 0x01)
	{
		Eq_n v36_n = ds->*((word32) di + ((word16) bx_n + 40)) - ah_n - (sp_n - 18);
		ds->*((word32) di + ((word16) bx_n + 40)) = v36_n;
		ds->*((word32) v31_n + 90) = ds->*((word32) v31_n + 90) - bh_n - (v36_n < 0x00);
	}
	else
	{
		...
		if (v37_n < 0x00)
		{
			while (true)
			{
				...
				byte bl_n = (byte) bx_n;
				byte bh_n = SLICE(bx_n, byte, 8);
				sp_n = (struct Eq_n Eq_n::*) ((char *) fp + 420);
				byte cl_n = (byte) cx_n;
				if (!CZ_n)
					break;
				...
				si_n = (word32) si_n + 1;
				byte ah_n = SLICE(fp + ~0x7055, byte, 8) | Mem209[ss:(fp + 0x0D8F) + si_n:byte];
				es = psegArg01A4;
				bp_n = (struct Eq_n Eq_n::*) ((char *) fp + 394);
				byte bl_n = SLICE(bx_n + 0x01, byte, 0);
				byte bl_n = SLICE(bx_n + 0x01, byte, 0);
				byte bh_n = SLICE(bx_n + 0x01, byte, 8);
				ax_n = SEQ(ah_n, (byte) ((char *) fp + 0x00008FAA));
				byte cl_n = (byte) (cx_n - 0x01);
				byte ch_n = SLICE(cx_n - 0x01, byte, 8);
				if (ah_n != 0x00 || cx_n == 0x01)
				{
					Mem228[bx_n:bx_n + 0x01 + si_n:word16] = Mem209[bx_n:bx_n + 0x01 + si_n:word16] + ax_n;
					byte cl_n = cl_n - bx_n->*((word32) si_n + 95);
					byte al_n = bx_n->*si_n;
					byte ah_n = ah_n ^ Mem244[bx_n:(bx_n + 0x02) + (si_n + 1):byte];
				...
				CZ_n.u0 = SLICE(cond(ax_n - ((char *) fp + 394)), bool, 2);
				--cx_n;
	...
	ci8 v39_n = *((word32) ds_di + 45) - (al_n | 0x3F);
	*((word32) ds_di + 45) = v39_n;
	es->*di = al_n | 0x3F;
	S_n = (bool) cond(v39_n);
	di_n = (word32) di + 1;
	ds_bx_n = (int32) bx_n;
		...
		if (dx_n == 0x00)
		{
			...
			if (dx_n != 0x00 || cx == 0x01)
			{
				...
				*((word32) es + 763) = al_n;
				...
				bx_n = sp_n[8];
				es->*di_n = (byte) ax_n;
				Eq_n v37_n = (word32) bx_n + ds->*((word32) bx_n + ((word16) di_n + 1));
				ds->*((word32) bx_n + ((word16) di_n + 1)) = v37_n;
			...
			if (al_n != 0x00)
			{
				byte bh_n = bh_n | ds->*((byte) bx.u0 + 3);
				(ss->*sp_n).tFFFFFFFE = es;
				cxOut.u0 = <invalid>;
				dhOut.u0 = <invalid>;
				bxOut = SEQ(bh_n, bl_n);
				bpOut = bp - 0x02;
